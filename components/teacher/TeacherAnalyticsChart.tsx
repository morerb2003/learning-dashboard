  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <section className="relative overflow-hidden rounded-2xl border border-white/5 bg-white/[0.02] p-5">
        ...
        <div className="w-full h-56 min-h-[224px] min-w-0 relative">
          {isMounted ? (
      ...
      <section className="relative overflow-hidden rounded-2xl border border-white/5 bg-white/[0.02] p-5">
        ...
        <div className="w-full h-56 min-h-[224px] min-w-0 relative flex items-center justify-center">
          {isMounted ? (
            <ResponsiveContainer width="100%" height="100%" minWidth={0} minHeight={200} debounce={50}>
              <PieChart>
                <Pie
